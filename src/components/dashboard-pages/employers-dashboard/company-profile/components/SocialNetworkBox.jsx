...
const SocialNetworkBox = () => {
  ...
  const onSubmit = async (data) => {
    try {
      await axios.put("https://api.sentryspot.co.uk/api/employeer/company", data, {
        headers: {
          "Content-Type": "application/json",
          Authorization: token,
        },
  ...
  return (
    <FormProvider {...methods}>
      <form className="max-w-7xl mx-auto p-6 bg-white rounded-lg shadow-lg" onSubmit={handleSubmit(onSubmit)}>
        {/* Basic Info Section */}
        <FormSection>
          <SectionTitle>Basic Information</SectionTitle>
          <BasicInformation />
        ...
        <FormSection>
          <SectionTitle>About Company</SectionTitle>
          <AboutCompany token={token} BASE_IMAGE_URL={BASE_IMAGE_URL} />
        </FormSection>

        {/* Inside Company Images Section */}
        <FormSection>
          <SectionTitle>Inside Company Images</SectionTitle>
          <InsideCompanyImages token={token} BASE_IMAGE_URL={BASE_IMAGE_URL} />
        </FormSection>

        {/* Watch What We Say Section */}
        {/* <WatchWhatWeSaySection /> */}
