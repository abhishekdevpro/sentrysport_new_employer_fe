...
//             {/* <SearchBox /> */}
//             <ul className="contacts overflow-y-auto h-full max-h-[calc(100vh-100px)] scrollbar-custom pr-1">
//                 {jobSeekers.length > 0 ? (
//                     jobSeekers.map((jobSeeker, index) => (
//                         <li 
//                             key={jobSeeker.jobskkers_detail.id || index} 
//                             className={`hover:bg-gray-100 rounded-lg transition-all duration-200 mb-2 ${jobSeeker.isActive ? "bg-blue-50 border-l-4 border-blue-500" : ""}`}
//                         >
...
//                                         <p className="text-sm text-gray-500 truncate">{jobSeeker.title || "Job Seeker"}</p>
//                                     </div>
//                                 </div>
//                             </div>
//                         </li>
...
// export default function EnhancedChatboxContactList() {
//     return (
//         <>
//             <ScrollbarStyles />
//             <ChatboxContactList />
