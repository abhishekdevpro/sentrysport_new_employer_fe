...
export const handleSendOTP = async (email) => {
   try {
      const response = await axiosInstance.post("/employeer/auth/send-loginotp", {email});
...
export const verifyOtpLogin = async (email, otp) => {
   try {
      const response = await axiosInstance.post("/employeer/auth/login-otp", { email, otp });
...
export const handleGoogleSignIn = async () => {
   try {
     const response = await axiosInstance.get('/employeer/auth/google');
